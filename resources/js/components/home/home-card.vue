        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-4 px-3 px-lg-5 pb-4 pb-md-0">
                    <router-link class="homeCard__link--major" to="/data/majors" @click="setDataPage('majors')">
                ...
                <div class="col-12 col-md-4 px-3 px-lg-5 pb-4 pb-md-0">
                    <router-link class="homeCard__link--industries" to="/data/industries" @click="setDataPage('industries')">
                ...
                <div class="col-12 col-md-4 px-3 px-lg-5">
                    <router-link class="homeCard__link--PFRE" to="/data/pfre" @click="setDataPage('pfre')">
