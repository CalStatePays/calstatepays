                    ...
                    <div data-app>
                        <campus-modal v-if="selectedDataPage !== 'pfre'">
                            <template #change-button>
                                <span class="CSUDataImgBanner__changeCampus font-weight-bold" href="#">Change Campus</span>
                            </template>
                        </campus-modal>
                    </div>
                </div>
                <div class="CSUDataImgBanner__dataInfoWrapper col-12 col-md-10 col-lg-8">
