<template>
    <nav id="sub-nav" class="sub-nav container-fluid">
        <div class="row">
            <router-link class="col-4 sub-nav__element" active-class="sub-nav__element--active" to="/data/majors" @click="setDataPage('majors')">
                <i class="sub-nav__element__mobile-icon fa fa-cog fa-fw fa-graduation-cap fa-2x" aria-hidden="true"></i>
                <span>Majors</span>
            </router-link>
            <router-link class="col-4 sub-nav__element" exact-active-class="sub-nav__element--active" to="/data/industries" @click="setDataPage('industries')">
                <i class="sub-nav__element__mobile-icon fa fa-cog fa-fw fa-industry fa-2x" aria-hidden="true"></i>
                <span>Industries</span>
            </router-link>
            <router-link class="col-4 sub-nav__element" active-class="sub-nav__element--active" to="/data/pfre" @click="setDataPage('pfre')">
